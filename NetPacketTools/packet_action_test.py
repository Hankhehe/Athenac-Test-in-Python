...
class PacketActionTest(PacketAction):
    ...
    def SendRadiusCoARequest(self):
        ...
        serverIP ='192.168.10.233'
        radiuspacket = Radius(id=90,code=40,authenticator=bytes.fromhex('0'*32)
        ...
        # ,RadiusAttr_Vendor_Specific(vendor_id=9,vendor_type=1,value=b'audit-session-id=AC11FFE90000027A5FA080B6')
